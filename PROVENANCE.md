...
**Repository:** stop-machine
**Purpose:** Deterministic three-state stop controller. Once RED, nothing runs. Fail-closed halt primitive.
**Author:** Ricky Dean Jones
**Repository owner:** [LalaSkye](https://github.com/LalaSkye)
**Organisation:** Os-Trilogy LMT / AlvianTech
**Architecture layer:** Control primitive
**Licence:** MIT

## Related Artefacts

TrinityOS, AlvianTech, Execution Boundary Series, constraint-workshop

## Public vs Private

**Public (this repository):** Full implementation, tests, API, geometry export spec.

**Private (withheld by design):** Integration with larger orchestration systems.
